...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RemoCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"", "comm.coinexplorers.com"}, //Evan's seed node
    {"", "162.243.33.16"},
    {NULL, NULL},
};

static const char *strTestNetDNSSeed[][2] = {
    {"FistSeed", "comm.coinexplorers.com"},
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RemoCoin is probably already running."), addrBind.ToString().c_str());
        else
